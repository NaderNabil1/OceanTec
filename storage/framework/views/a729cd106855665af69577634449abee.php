            ...
            <div class="site-sidebar">
                ...
                <div class="custom-scroll custom-scroll-light">
                    <ul class="sidebar-menu">
                        <li class="menu-title m-t-0-5">Dashboard</li>
                        ...
                        <li <?php if(Route::current()->getName() == 'be-admins'): ?> class="active" <?php endif; ?>>
...
<?php /**PATH E:\Nader\OceanTec\resources\views/Dashboard/app.blade.php ENDPATH**/ ?>